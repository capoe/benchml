"""Model classifications for molecular datasets."""
...
bmol_acsf_base = ["bmol_acsf_longrange", "bmol_acsf_minimal", "bmol_acsf_smart"]
...
bmol_gylm_base = ["bmol_gylm_minimal", "bmol_gylm_standard"]
...
bmol_soap_base = ["bmol_soap_longrange", "bmol_soap_minimal", "bmol_soap_smart"]
bmol["soap"] = base2model(
    base2model(base2model(bmol_soap_base, ["cross", "nocross"]), ["ext", "int"]), ["rr", "krr"]
)
...
bxtal_acsf_base = ["bxtal_acsf_longrange", "bxtal_acsf_minimal", "bxtal_acsf_smart"]
...
bxtal_gylm_base = ["bxtal_gylm_minimal", "bxtal_gylm_standard"]
...
bxtal_soap_base = ["bxtal_soap_longrange", "bxtal_soap_minimal", "bxtal_soap_smart"]
bxtal["soap"] = base2model(
    base2model(base2model(bxtal_soap_base, ["cross", "nocross"]), ["ext", "int"]), ["rr", "krr"]
)
